...
agenda.define("Converting commits to orders v3.1-", function(job, done) {
    console.log("hello1");
    Sales.find({
...
agenda.define("Refreshing Sales which expired in last 24h v1.0", function(
    job,
    done
) {
    console.log("hello2");
...
agenda.on("ready", function() {
    ...
    agenda.schedule(
        "2 seconds",
        agenda.every("2 hours", "Converting commits to orders v3.1-")
    );
    agenda.schedule(
        "2 seconds",
        agenda.every(
            "24 hours",
            "Refreshing Sales which expired in last 24h v1.0"
        )
    );
    agenda.start();
});
